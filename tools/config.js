...
const entries = [
  'charts/line/basic-line-chart/index',
  'charts/pie/donut-chart/index',
  'charts/pie/progress-bar/index'
];
...
module.exports = {
  ...
  webpack: {
    ...
    plugins: [new webpack.DefinePlugin({}), new webpack.optimize.LimitChunkCountPlugin({ maxChunks: 1 })],
    optimization: {
      minimize: false,
    },
